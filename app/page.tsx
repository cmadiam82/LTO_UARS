"use client";
/* eslint-disable @next/next/no-img-element -- direct static PNG avoids the Vinext optimizer failure in production */
  ...
  return (
    <main className="app-shell">
      ...
      <aside className="sidebar">
        <div className="brand"><AgencyLogos compact/><div><strong>LTOCM</strong><span>LTO Credentials Management · v1.2.1</span></div></div>
